...
TrackingTools::TrackingTools(void)
{
}
...
void
TrackingTools::flannFindPairs( const CvSeq*, const CvSeq* objectDescriptors,
...
int
TrackingTools::locatePlanarObject( const CvSeq* objectKeypoints, const CvSeq* objectDescriptors,
